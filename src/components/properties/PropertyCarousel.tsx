...
function PropertyCard({ property }: { property: CarouselProperty }) {
...
export function PropertyCarousel({ properties }: PropertyCarouselProps) {
  ...
  const visibleProperties = properties.slice(startIndex, startIndex + perPage);
    ...
    >
      ...
      {totalPages > 1 && (
        <div className="mt-8 flex items-center justify-center gap-4">
          <button
            onClick={prevPage}
            className="rounded-full border border-secondary-600 bg-secondary-800 p-2 text-white transition-all hover:border-primary-500 hover:bg-secondary-700"
