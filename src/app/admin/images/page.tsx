...
export default function AdminImagesPage() {
  ...
  const fetchImages = useCallback(async () => {
    if (!selectedPropertyId || !authenticated) return;
  ...
  }, [selectedPropertyId, authenticated, authHeaders]);
        ...
        <Card className="w-full max-w-sm" padding="lg">
          ...
          <form onSubmit={handleLogin}>
            ...
            <input
              ...
              className="mb-4 w-full rounded-lg border border-secondary-600 bg-secondary-800/50 px-4 py-2.5 text-sm text-white focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary-500"
